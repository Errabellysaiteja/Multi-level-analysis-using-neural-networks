...
model = load_model('C:\Users\Test\Desktop\final_proj\archive')

# Path to the baseline images directory
BASELINE_IMAGE_DIR = r'C:\Users\Test\Desktop\final_proj\multi-level-medical-analysis-neural-networks-main\multi-level-medical-analysis-neural-networks-main\Brain MRI Images\Train\Normal'
